...
public class ServerMaster extends Thread {
    ...
    private int port;
    ServerMaster(FileSystemManager fileSystemManager, ConnectionCounter connectionCounter){
        this.fileSystemManager = fileSystemManager;
        this.serverThreads = new ArrayList<ServerThread>();
        this.connectionCounter = connectionCounter;
        this.port = Integer.parseInt(Configuration.getConfiguration().get("port"));
        start();
    }
    ...
    public void run(){
        try{
            ...
            while (true) {
                ...
                ServerThread serverThread = new ServerThread(fileSystemManager,client,connectionCounter, serverThreads);
                synchronized (serverThreads) {
