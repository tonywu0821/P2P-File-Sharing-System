...
public class ClientThread extends Thread {
    ...
    ClientThread(FileSystemManager fileSystemManager, Document peer, ConnectionCounter connectionCounter, ArrayList<ClientThread> clientThreads){
        this.fileSystemManager = fileSystemManager;
        this.peer = peer;
        this.connectionCounter = connectionCounter;
        this.syncInterval = Integer.parseInt(Configuration.getConfiguration().get("syncInterval"));
    ...
    public void run(){
        ...
        String localPort = Configuration.getConfiguration().get("port");
    ...
    private void connectToPeer(Document hostPort) {
        ...
        while (counter > 0) {
            ...
            try {
                ...
                Socket toPeer = new Socket(host, port);
